...
FROM city c 
JOIN country c2 ON c2.country_id = c.country_id 
GROUP BY c2.country, c2.country_id HAVING COUNT(c.city)>10 ORDER BY quantity_cities DESC;
...
FROM customer c 
JOIN address a ON a.address_id = c.address_id ORDER BY total_spent DESC;
